    ...
    callback: function () {
        ...
        fetch('https://restcountries.com/v3.1/all?fields=name,flags,capital,population,currencies,languages,continents')
            ...
            .then(data => {
                ...
                data.push(JSON.parse('{"flags":{"png":"https://flagcdn.com/w320/st.png","svg":"https://flagcdn.com/st.svg","alt":"The flag of South Sudan is composed of three equal horizontal bands of black, red with white top and bottom edges, and green. A blue equilateral triangle which spans about two-fifth the width of the field is superimposed on the hoist side with its base on the hoist end of the field. At the center of this triangle is a five-pointed yellow star."},"name":{"common":"ST","official":"Democratic Republic of São Tomé and Príncipe","nativeName":{"por":{"official":"República Democrática do São Tomé e Príncipe","common":"São Tomé e Príncipe"}}},"currencies":{"STN":{"name":"São Tomé and Príncipe dobra","symbol":"Db"}},"capital":["São Tomé"],"languages":{"por":"Portuguese"},"population":219161,"continents":["Africa"]}'))
                data.push(JSON.parse('{"flags":{"png":"https://flagcdn.com/w320/tf.png","svg":"https://flagcdn.com/tf.svg","alt":""},"name":{"common":"TF","official":"Territory of the French Southern and Antarctic Lands","nativeName":{"fra":{"official":"Territoire des Terres australes et antarctiques françaises","common":"Terres australes et antarctiques françaises"}}},"currencies":{"EUR":{"name":"Euro","symbol":"€"}},"capital":["Port-aux-Français"],"languages":{"fra":"French"},"population":400,"continents":["Antarctica"]}'))
